...
<body>
    ...
    <div class="min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class=" item-center justify-center hidden">
            <div class="w-full max-w-md space-y-8">
                <div>

                    <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign up
                    </h2>
                ...
                <form class="mt-8 space-y-6" action="/questionnary" method="GET">
                    ...
                    <div class="-space-y-px rounded-md shadow-sm">
                        ...
                        <div class=" mb-3">
                            <label for="password" class="sr-only">Re-write the password</label>
                            <input id="password" name="password" type="password" autocomplete="current-password"
                                required
                                class="relative block w-full appearance-none  rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                                placeholder="Password">
