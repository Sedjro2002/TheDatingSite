...
<head>
    ...
    <title>TheDatingSite</title>
</head>

<body>
    <!-- This example requires Tailwind CSS v2.0+ -->
    <div class="relative overflow-hidden h-screen bg-white">
        <div class="mx-auto h-screen max-w-7xl">
            <div class="relative z-10 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
                <svg class="absolute inset-y-0 right-0 hidden h-screen w-48 translate-x-1/2 transform text-white lg:block"
                    style="fill:linear-gradient(to right top, rgb(239, 68, 68), rgb(34, 197, 94))" viewBox="0 0 100 100"
                            ...
                            <div class="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                                <div class="flex w-full items-center justify-between md:w-auto">
                                    <a href="#">
                                        ...
                                        <img alt="Your Company" class="h-8 w-auto bg-black sm:h-10" src="">
                                    </a>
        ...
        -->
                    <div class="absolute inset-x-0 top-0 z-10 origin-top-right transform p-2 transition md:hidden">
                        <div class="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
                            <div class="flex items-center justify-between px-5 pt-4">
                                <div>
                                    <img class="h-8 w-auto bg-black" src="" alt="The Logo">
                                </div>
                                <div class="-mr-2">
                                    <button type="button"
                                        class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
              ...
              <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900">Company</a> --}}
                            ...
                            <a href="#"
                                class="block w-full bg-gray-50 px-5 py-3 text-center font-medium text-pink-500 hover:bg-gray-100">Log
                                in</a>
                        </div>
                    </div>
                </div>
                ...
                <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block xl:inline">The site to meet</span>
                            <span class="block text-blue-600 xl:inline">your</span><span
                                class="block text-pink-600 xl:inline"> soulmate</span>
                        </h1>
                        <p
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                            <div class="rounded-md shadow">
                                <a href="/signInUp"
                                    class="flex w-full items-center justify-center rounded-md border border-transparent bg-pink-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-600 md:py-4 md:px-10 md:text-lg">Get
                                    started</a>
                            </div>
