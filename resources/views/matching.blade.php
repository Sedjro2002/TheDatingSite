        ...
        <div class="w-1/2 h-screen align-middle bg-gradient-to-tl from-blue-200 via-blue-400 to-blue-600">
            <div class="w-2/3 h-2/3 p-7 mx-auto mt-20  rounded-xl  text-center bg-blue-800">
                <div class="flex justify-center">
                    <div class="w-32 h-32 rounded-full my-6 text-center align-middle text-white bg-black">profil picture
                    </div>
                </div>
                ...
                <div class="inline-block justify-between mt-12  sm:mt-5">
                    ...
                    <button
                        class="px-4 py-1 text-sm text-blue-600 font-semibold rounded-full border border-blue-200 hover:text-white hover:bg-blue-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">NO</button>
                </div>
            </div>
        </div>
        <div class="w-1/2 h-screen bg-gradient-to-r from-pink-200 via-pink-400 to-pink-600">
            <div class="w-2/3 h-2/3 p-7 mx-auto mt-20  rounded-xl  text-center bg-pink-800">
                <div class="flex justify-center">
                    <div class="w-32 h-32 rounded-full my-6 text-center align-middle text-white bg-black">profil picture
                    </div>
                </div>
                ...
                <div class="inline-block justify-between mt-12 sm:mt-5">
                    ...
                    <button
                        class="px-4 py-1 text-sm text-pink-600 font-semibold rounded-full border border-pink-200 hover:text-white hover:bg-pink-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-pink-600 focus:ring-offset-2">NO</button>
                </div>
            </div>
        </div>
